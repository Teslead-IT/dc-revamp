...
export function ItemDeleteDialog({ open, onOpenChange, onConfirm, itemName, itemId }: ItemDeleteDialogProps) {
            ...
            <AlertDialogContent className="bg-[#1e293b] border-slate-700 p-0 overflow-hidden max-w-[500px] gap-0">
                    ...
                    <>
                        ...
                        <div className="relative pt-8 px-6 pb-2">
                            ...
                            <AlertDialogHeader className="mt-4">
                                <AlertDialogTitle className="sr-only">Delete Item</AlertDialogTitle>
                                <AlertDialogDescription className="text-slate-300 text-sm leading-relaxed mt-2">
                                    Are you sure you want to delete this item? This action will permanently remove the item and all associated data from the system.
                                    {itemName && itemId && (
                                        <span className="block mt-3 p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                                            <span className="block text-xs text-slate-500 mb-1">Item Details</span>
                ...
                {status === 'loading' && (
                    <div className="p-12 flex flex-col items-center justify-center">
                        ...
                        <p className="text-slate-300 text-sm">Deleting item...</p>
                    </div>
                )}
