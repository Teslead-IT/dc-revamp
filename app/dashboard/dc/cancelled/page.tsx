...
export default function CancelledDCPage() {
  const data = getDCByStatus("cancelled")
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-semibold text-slate-900 lg:text-2xl">Cancelled Delivery Challans</h1>
