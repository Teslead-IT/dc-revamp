...
export default function ClosedDCPage() {
  const data = getDCByStatus("closed")
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-semibold text-slate-900 lg:text-2xl">Closed Delivery Challans</h1>
